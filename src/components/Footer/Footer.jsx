  ...
  return (
    <div className="footer-container d-flex-fd-column j-center">
      ...
      <div className="copyright-text">
        <p>
          MIMEANIME does not retain any files on its server. Rather, it solely provides links to media content hosted by third-party services.
        </p>
        <p>&copy; MIMEANIME. All rights reserved.</p>
      </div>
    </div>
  );
}
